    ...
    public static ConfigBuilder getConfigBuilder(BaseModule module) {
        ...
        if (module instanceof CoordsModule coordsModule) {
            ...
            if (coordsModule.colorX != null && coordsModule.defaultColorX != null) {
                ColorEntry colorX = entryBuilder.startColorField(new TranslatableComponent("config.betterf3.color" +
                        ".x"), coordsModule.colorX.getValue())
            ...
            if (coordsModule.colorY != null && coordsModule.defaultColorY != null) {
                ColorEntry colorY = entryBuilder.startColorField(new TranslatableComponent("config.betterf3.color" +
                        ".y"), coordsModule.colorY.getValue())
            ...
            if (coordsModule.colorZ != null && coordsModule.defaultColorZ != null) {
                ColorEntry colorZ = entryBuilder.startColorField(new TranslatableComponent("config.betterf3.color" +
                        ".z"), coordsModule.colorZ.getValue())
        ...
        if (module instanceof FpsModule fpsModule) {
            ...
            if (fpsModule.colorHigh != null && fpsModule.defaultColorHigh != null) {
                ColorEntry colorHigh = entryBuilder.startColorField(new TranslatableComponent("config.betterf3" +
            ...
            if (fpsModule.colorMed != null && fpsModule.defaultColorMed != null) {
                ColorEntry colorMed = entryBuilder.startColorField(new TranslatableComponent("config.betterf3" +
            ...
            if (fpsModule.colorLow != null && fpsModule.defaultColorLow != null) {
                ColorEntry colorLow = entryBuilder.startColorField(new TranslatableComponent("config.betterf3" +
        ...
        if (module.nameColor != null && module.defaultNameColor != null) {
            ColorEntry nameColor = entryBuilder.startColorField(new TranslatableComponent("config.betterf3.color" +
                    ".name"), module.nameColor.getValue())
        ...
        if (module.valueColor != null && module.defaultValueColor != null) {
            ColorEntry valueColor = entryBuilder.startColorField(new TranslatableComponent("config.betterf3.color" +
                    ".value"), module.valueColor.getValue())
