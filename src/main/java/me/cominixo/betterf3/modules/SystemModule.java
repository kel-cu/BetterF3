...
public class SystemModule extends BaseModule {
    ...
    public void update(Minecraft client) {
        ...
        String displayInfo = String.format("%d x %d (%s)", window.getScreenWidth(),
                window.getScreenHeight(), GlUtil.getOpenGLVersion());
        ...
        lines.get(5).setValue(GlUtil.getOpenGLVersion());
