...
public class FpsModule extends BaseModule{
    ...
    public void update(Minecraft client) {
        ...
        String fpsString = I18n.get("format.betterf3.fps", currentFps,
                (double)client.options.framerateLimit == Option.FRAMERATE_LIMIT.getMaxValue() ?
                        I18n.get("text.betterf3.line" +
                        ".fps.unlimited") : client.options.framerateLimit,
